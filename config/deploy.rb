...
set :application, "tfgjorge"
set :repo_url, "git@github.com:JorgeVelaPlaza/tfgjorge.git"
...
set :rvm_ruby_version, '1.28.0'
set :rvm_custom_path, "/opt/bitnami/rvm/bin" # only needed if not detected
